...
import "./studentscheduleappointment.css";
...
const StudentScheduleAppointment = (props) => {
  ...
  useEffect(() => {
    setStudent(JSON.parse(localStorage.getItem(props.storageKey)));
  }, []);

  const handleSubmit = async () => {
    const appointment = {};
    appointment.studentID = student.id;
    appointment.teacherID = props.data.id;
        ...
        <section>
          <div className="schedule-appointment-row"> 
            <div className="grid-container">
              ...
              <span className="val">{props.data.email}</span>

              <label>Teacher Name:</label>
              <span className="val">{props.data.name}</span>
